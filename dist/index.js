...
client.on(Events.MessageCreate, (message) => {
    [nixosRegex, windowsRegex, alpineRegex, voidRegex, archRegex].forEach((regex) => {
            ...
            message.reply({
                embeds: [
                    new EmbedBuilder()
                        ...
                        .setDescription(`The currently most mentioned OS is ${Object.entries(mental.getMostMentionedOS())
                        .sort((a, b) => b[1] - a[1])
                        .map(([os]) => os)[0]}`)
                        .setTimestamp(new Date())
                        .setFields(Object.entries(mental.getMostMentionedOS()).map(([os, count]) => ({
                        name: os,
